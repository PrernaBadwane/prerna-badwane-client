...
const DevelopmentSteps = ({variant}:{variant:boolean}) => {
  return (
    <div className="bg-primary-30 dark:bg-primary-05 py-10 md:py-[100px]">
      <Container>
       
          <div className="flex flex-col md:flex-row gap-4 items-start xs:items-center md:items-end justify-between z-10 relative pb-10 md:pb-[70px]">
            <Heading
      ...
      <DevelopmentStepsSwiper variant={variant} />
    </div>
  );
};
